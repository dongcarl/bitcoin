...
$(foreach tool,CC CC_CMD CC_CMD_WRAPPER CXX CXX_CMD CXX_CMD_WRAPPER AR RANLIB STRIP NM LIBTOOL OTOOL INSTALL_NAME_TOOL,$(eval $(call add_host_tool_func,$(tool))))
