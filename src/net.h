...
public:
    V2TransportDeserializer(const CPrivKey& k1, const CPrivKey& k2) : m_aead(new ChaCha20Poly1305AEAD(k1.data(), k1.size(), k2.data(), k2.size())), vRecv(SER_NETWORK, INIT_PROTO_VERSION)
    {
        Reset();
    }
